...
# Use this code as a starting point for creating specific test data

"""Create test data for the DCCD archive
...
Usage:
	create_testdata.py [-d DIR]
	create_testdata.py ( -h | --help)
	
Options:
	-h --help         Show this screen
	-d DIR            Output directory [default: data]
...
In this case the project name
"""
def createProject(i):
	projectName = "test" + str(i)
	...
	tridasFile.write(constructTridas(projectName))
	tridasFile.close()
